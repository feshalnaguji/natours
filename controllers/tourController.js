...
// /tours-within/200/center/34,-118/unit/mi
...
exports.getDistances = catchAsync(async (req, res, next) => {
  ...
  const distances = await Tour.aggregate([
    // geoNear always needs to be first stage also one of the field should contains geoSpatial index (startLocation in our ex.)
    {
      $geoNear: {
        near: {
          type: 'Point',

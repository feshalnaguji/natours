class APIFeatures {
  constructor(query, queryString) {
    // query is mongoose query object, and queryString is express query in we get from url
    this.query = query;
    this.queryString = queryString;
  }

  filter() {
    const queryObj = { ...this.queryString }; // creating a shallow copy of req.query object
